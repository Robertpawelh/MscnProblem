...
void CRandomSearch::vInitialize() {
	bool b_is_success;
	string s_error_code;
	pd_current_best = CRandomSolutionGenerator::pd_random_cmscn_solution(c_generator, pc_problem);
...
void CRandomSearch::vRunIteration() {
	...
	double* pd_current_solution = CRandomSolutionGenerator::pd_random_cmscn_solution(c_generator, pc_problem);

	pd_current_solution = CRandomSolutionGenerator::pd_random_cmscn_solution(c_generator, pc_problem);
